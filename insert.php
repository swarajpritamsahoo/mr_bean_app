...
if(isset($_POST['done'])) {
  ...
  $q = " INSERT INTO `mrbeanapp`(`id`, `companylname`, `modelname`, `colorname`, `dateofpur`, `price`, `enginecap`, `seatingcap`, `licencenum`) VALUES ( 
  '$companyname', '$modelname', '$colorname', '$dateofpur', '$price', '$enginecap', '$seatingcap', '$licencenum')";
